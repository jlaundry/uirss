...
REQ_RELEASE_DATA = {
    ...
    "query": "query GetReleases($limit: Int, $offset: Int, $searchTerm: String, $sortBy: ReleasesSortBy, $stage: ReleaseStage, $statuses: [ReleaseStatus!], $tagMatchType: TagMatchType, $tags: [String!], $betas: [String!], $alphas: [String!], $type: ReleaseType, $featuredOnly: Boolean, $nonFeaturedOnly: Boolean, $userIsFollowing: Boolean) {\n  releases(\n    limit: $limit\n    offset: $offset\n    searchTerm: $searchTerm\n    sortBy: $sortBy\n    stage: $stage\n    statuses: $statuses\n    tagMatchType: $tagMatchType\n    tags: $tags\n    betas: $betas\n    alphas: $alphas\n    type: $type\n    featuredOnly: $featuredOnly\n    nonFeaturedOnly: $nonFeaturedOnly\n    userIsFollowing: $userIsFollowing\n  ) {\n    items {\n      ...BasicRelease\n      __typename\n    }\n    pageInfo {\n      limit\n      offset\n      __typename\n    }\n    totalCount\n    __typename\n  }\n}\n\nfragment BasicRelease on Release {\n  id\n  slug\n  type\n  title\n  version\n  stage\n  tags\n  betas\n  alphas\n  isFeatured\n  isLocked\n  stats {\n    comments\n    views\n    __typename\n  }\n  createdAt\n  lastActivityAt\n  updatedAt\n  userStatus {\n    ...UserStatus\n    __typename\n  }\n  author {\n    ...UserWithStats\n    __typename\n  }\n  publishedAs {\n    ...User\n    __typename\n  }\n  __typename\n}\n\nfragment UserStatus on UserStatus {\n  isFollowing\n  lastViewedAt\n  reported\n  vote\n  __typename\n}\n\nfragment UserWithStats on User {\n  ...User\n  stats {\n    questions\n    answers\n    solutions\n    comments\n    stories\n    score\n    __typename\n  }\n  __typename\n}\n\nfragment User on User {\n  id\n  username\n  title\n  slug\n  avatar {\n    color\n    content\n    image\n    __typename\n  }\n  isEmployee\n  registeredAt\n  lastOnlineAt\n  groups\n  showOfficialBadge\n  canBeMentioned\n  canViewProfile\n  canStartConversationWith\n  __typename\n}\n"
}
